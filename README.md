...
```
bash <(wget -qO- https://github.com/Jhowmt1989/Jhowpainelweb/raw/main/painelwv5/ubuinst.sh)
```
...
```
apt install wget -y; bash <(wget -qO- https://github.com/Jhowmt1989/Jhowpainelweb/raw/main/painelwv5/sincpainel.sh)
```
